...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-charcoal py-2 mt-0">
        {/* Compliance Text */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-t border-stone-800 pt-5 mt-4">
